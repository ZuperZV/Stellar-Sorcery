...
@OnlyIn(Dist.CLIENT)
public class SylphEmberParticle extends TextureSheetParticle {
    protected SylphEmberParticle(ClientLevel p_107074_, double p_107075_, double p_107076_, double p_107077_) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            SylphEmberParticle sylphemberparticle = new SylphEmberParticle(p_107104_, p_107105_, p_107106_, p_107107_);
            sylphemberparticle.pickSprite(this.sprite);
            return sylphemberparticle;
        }
    }
}
