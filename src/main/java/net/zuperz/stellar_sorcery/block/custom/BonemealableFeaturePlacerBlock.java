...
public class BonemealableFeaturePlacerBlock extends Block implements BonemealableBlock {
    public static final MapCodec<BonemealableFeaturePlacerBlock> CODEC = RecordCodecBuilder.mapCodec((p_432632_) -> p_432632_.group(ResourceKey.codec(Registries.CONFIGURED_FEATURE).fieldOf("feature").forGetter((p_380141_) -> p_380141_.feature), propertiesCodec()).apply(p_432632_, BonemealableFeaturePlacerBlock::new));
