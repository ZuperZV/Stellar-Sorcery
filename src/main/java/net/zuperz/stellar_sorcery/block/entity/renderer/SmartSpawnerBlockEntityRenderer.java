...
@OnlyIn(Dist.CLIENT)
public class SmartSpawnerBlockEntityRenderer implements BlockEntityRenderer<SmartSpawnerBlockEntity> {
    private final EntityRenderDispatcher entityRenderer;

    public SmartSpawnerBlockEntityRenderer(BlockEntityRendererProvider.Context p_173673_) {
        this.entityRenderer = p_173673_.getEntityRenderer();
    }

    public void render(SmartSpawnerBlockEntity p_112563_, float p_112564_, PoseStack p_112565_, MultiBufferSource p_112566_, int p_112567_, int p_112568_) {
    ...
    @Override
    public net.minecraft.world.phys.AABB getRenderBoundingBox(SmartSpawnerBlockEntity blockEntity) {
