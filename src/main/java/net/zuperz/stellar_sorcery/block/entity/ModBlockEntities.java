...
public class ModBlockEntities {
    ...
    public static final Supplier<BlockEntityType<ItemEmitterBlockEntity>> ITEM_EMITTER_BE =
            BLOCK_ENTITIES.register("item_emitter_be", () -> BlockEntityType.Builder.of(
                    ItemEmitterBlockEntity::new, ModBlocks.ITEM_EMITTER.get()).build(null));
