...
public class CustomSmithingTemplateItem  extends Item {
    ...
    public static CustomSmithingTemplateItem createTemplateFromMaterial(String materialName, FeatureFlag... flags) {
        ResourceLocation materialLocation = ResourceLocation.fromNamespaceAndPath(StellarSorcery.MOD_ID, materialName);

        Component appliesTo = Component.translatable(
                Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(StellarSorcery.MOD_ID, "smithing_template." + materialName + ".applies_to"))
        ).withStyle(ChatFormatting.BLUE);

        Component ingredients = Component.translatable(
                Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(StellarSorcery.MOD_ID, "smithing_template." + materialName + ".ingredients"))
        ).withStyle(ChatFormatting.BLUE);

        Component upgradeDescription = Component.translatable(
                Util.makeDescriptionId("upgrade", materialLocation)
        ).withStyle(ChatFormatting.GRAY);

        Component baseSlotDescription = Component.translatable(
                Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(StellarSorcery.MOD_ID, "smithing_template." + materialName + ".base_slot_description"))
        );

        Component additionsSlotDescription = Component.translatable(
                Util.makeDescriptionId("item", ResourceLocation.fromNamespaceAndPath(StellarSorcery.MOD_ID, "smithing_template." + materialName + ".additions_slot_description"))
        );
        ...
        List<ResourceLocation> additionalSlotIcons = List.of(
                ResourceLocation.withDefaultNamespace("item/empty_slot_" + materialName)
        );
